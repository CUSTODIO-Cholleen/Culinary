...
<body>
    ...
    <ul>
        ...
        <li><strong>Lime Leaves</strong>: 3 leaves</li>
    ...
    <h3>Cooking Tips:</h3>
    <ul>
        <li><sup>1/4 cup of fish sauce adds authentic Thai flavor.</sup></li>
        <li><sub>1 tablespoon of chili paste gives the soup its signature heat.</sub></li>
    </ul>
